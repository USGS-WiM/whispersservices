# Generated by Django 2.0 on 2018-06-26 19:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('administrative_level_one', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='administrativeleveltwos', to='whispersapi.AdministrativeLevelOne')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='circle_creator', to=settings.AUTH_USER_MODEL)),
                ('modified_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='circle_modifier', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateField(blank=True, db_index=True, default=datetime.date.today, null=True)),
                ('modified_date', models.DateField(auto_now=True, null=True)),
                ('circle', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='whispersapi.Circle')),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='circleuser_creator', to=settings.AUTH_USER_MODEL)),
                ('modified_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='circleuser_modifier', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('circle_read', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='readevents', to='whispersapi.Circle')),
                ('circle_write', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='writeevents', to='whispersapi.Circle')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='eventabstracts', to='whispersapi.Event')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='eventcases', to='whispersapi.Event')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateField(blank=True, db_index=True, default=datetime.date.today, null=True)),
                ('modified_date', models.DateField(auto_now=True, null=True)),
                ('contact', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='whispersapi.Contact')),
                ...
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='whispersapi.Event')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('diagnosis', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='eventdiagnoses', to='whispersapi.Diagnosis')),
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='eventdiagnoses', to='whispersapi.Event')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='eventlabsites', to='whispersapi.Event')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('administrative_level_one', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='eventlocations', to='whispersapi.AdministrativeLevelOne')),
                ('administrative_level_two', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='eventlocations', to='whispersapi.AdministrativeLevelTwo')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified_date', models.DateField(auto_now=True, null=True)),
                ('contact', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='whispersapi.Contact')),
                ('contact_type', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='eventlocationcontacts', to='whispersapi.ContactType')),
                ...
                ('event_location', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='whispersapi.EventLocation')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age_bias', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='locationspecies', to='whispersapi.AgeBias')),
                ...
                ('event_location', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='locationspecies', to='whispersapi.EventLocation')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('administrative_level_one', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='organizations', to='whispersapi.AdministrativeLevelOne')),
                ('country', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='organizations', to='whispersapi.Country')),
                ...
                ('parent_organization', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='child_organizations', to='whispersapi.Organization')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('diagnosis', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='speciesdiagnoses', to='whispersapi.Diagnosis')),
                ('location_species', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='speciesdiagnoses', to='whispersapi.LocationSpecies')),
                ...
                ('organization', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='speciesdiagnoses', to='whispersapi.Organization')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='staff', to='whispersapi.Role')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='sex_bias',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='locationspecies', to='whispersapi.SexBias'),
        ),
        migrations.AddField(
            model_name='locationspecies',
            name='species',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='locationspecies', to='whispersapi.Species'),
        ),
        migrations.AddField(
            model_name='eventsuperevent',
            name='superevent',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='whispersapi.SuperEvent'),
        ),
        migrations.AddField(
            model_name='eventorganization',
            name='organization',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='whispersapi.Organization'),
        ),
        migrations.AddField(
            model_name='eventlocation',
            name='contacts',
            field=models.ManyToManyField(related_name='eventlocations', through='whispersapi.EventLocationContact', to='whispersapi.Contact'),
        ),
        migrations.AddField(
            model_name='eventlocation',
            name='country',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='eventlocations', to='whispersapi.Country'),
        ),
        migrations.AddField(
            model_name='eventlocation',
            name='created_by',
        ...
        migrations.AddField(
            model_name='eventlocation',
            name='event',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='eventlocations', to='whispersapi.Event'),
        ),
        migrations.AddField(
            model_name='eventlocation',
            name='land_ownership',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='eventlocations', to='whispersapi.LandOwnership'),
        ),
        migrations.AddField(
            model_name='eventlocation',
            name='modified_by',
        ...
        migrations.AddField(
            model_name='event',
            name='contacts',
            field=models.ManyToManyField(related_name='event', through='whispersapi.EventContact', to='whispersapi.Contact'),
        ),
        migrations.AddField(
            model_name='event',
            name='created_by',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='event_creator', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='event',
            name='event_status',
            field=models.ForeignKey(default=1, on_delete='events', to='whispersapi.EventStatus'),
        ),
        migrations.AddField(
            model_name='event',
            name='event_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='events', to='whispersapi.EventType'),
        ),
        migrations.AddField(
            model_name='event',
            name='legal_status',
            field=models.ForeignKey(default=1, on_delete='events', to='whispersapi.LegalStatus'),
        ),
        migrations.AddField(
            model_name='event',
            name='modified_by',
        ...
        migrations.AddField(
            model_name='event',
            name='organizations',
            field=models.ManyToManyField(related_name='events', through='whispersapi.EventOrganization', to='whispersapi.Organization'),
        ),
        migrations.AddField(
            model_name='event',
            name='staff',
            field=models.ForeignKey(null=True, on_delete='events', to='whispersapi.Staff'),
        ),
        migrations.AddField(
            model_name='event',
            name='superevents',
            field=models.ManyToManyField(related_name='events', through='whispersapi.EventSuperEvent', to='whispersapi.SuperEvent'),
        ),
        migrations.AddField(
            model_name='diagnosis',
            name='diagnosis_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='diagnoses', to='whispersapi.DiagnosisType'),
        ),
        migrations.AddField(
            model_name='diagnosis',
            name='modified_by',
        ...
        migrations.AddField(
            model_name='contact',
            name='organization',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='contacts', to='whispersapi.Organization'),
        ),
        migrations.AddField(
            model_name='comment',
            name='comment_type',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='comments', to='whispersapi.CommentType'),
        ),
        migrations.AddField(
            model_name='comment',
            name='content_type',
        ...
        migrations.AddField(
            model_name='comment',
            name='created_by',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='comment_creator', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='comment',
            name='modified_by',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='comment_modifier', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='administrativelevelone',
            name='country',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='administrativelevelones', to='whispersapi.Country'),
        ),
        migrations.AddField(
            model_name='administrativelevelone',
            name='created_by',
        ...
        migrations.AddField(
            ...
            name='country',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='country', to='whispersapi.Country'),
        ),
        migrations.AddField(
            model_name='administrativelevellocality',
            name='created_by',
        ...
        migrations.AddField(
            model_name='user',
            name='circles',
            field=models.ManyToManyField(related_name='users', through='whispersapi.CircleUser', to='whispersapi.Circle'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
        ...
        migrations.AddField(
            model_name='user',
            name='organization',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='users', to='whispersapi.Organization'),
        ),
        migrations.AddField(
            model_name='user',
            name='role',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='users', to='whispersapi.Role'),
        ),
        migrations.AddField(
            model_name='user',
