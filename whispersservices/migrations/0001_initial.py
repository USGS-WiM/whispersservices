# Generated by Django 2.0 on 2018-06-21 22:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateField(blank=True, db_index=True, default=datetime.date.today, null=True)),
                ('modified_date', models.DateField(auto_now=True, null=True)),
                ('circle', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='whispersservices.Circle')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('circle_read', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='readevents', to='whispersservices.Circle')),
                ('circle_write', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='writeevents', to='whispersservices.Circle')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified_date', models.DateField(auto_now=True, null=True)),
                ('contact', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='whispersservices.Contact')),
                ('contact_type', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='eventlocationcontacts', to='whispersservices.ContactType')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age_bias', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='locationspecies', to='whispersservices.AgeBias')),
        ...
        migrations.AddField(
            ...
            name='sex_bias',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='locationspecies', to='whispersservices.SexBias'),
        ),
        migrations.AddField(
            model_name='locationspecies',
            name='species',
        ...
        migrations.AddField(
            ...
            name='contacts',
            field=models.ManyToManyField(related_name='eventlocations', through='whispersservices.EventLocationContact', to='whispersservices.Contact'),
        ),
        migrations.AddField(
            model_name='eventlocation',
            name='country',
        ...
        migrations.AddField(
            model_name='event',
            name='contacts',
            field=models.ManyToManyField(related_name='event', through='whispersservices.EventContact', to='whispersservices.Contact'),
        ),
        migrations.AddField(
            model_name='event',
            name='created_by',
        ...
        migrations.AddField(
            model_name='event',
            name='organizations',
            field=models.ManyToManyField(related_name='events', through='whispersservices.EventOrganization', to='whispersservices.Organization'),
        ),
        migrations.AddField(
            model_name='event',
            name='staff',
        ...
        migrations.AddField(
            model_name='event',
            name='superevents',
            field=models.ManyToManyField(related_name='events', through='whispersservices.EventSuperEvent', to='whispersservices.SuperEvent'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='user',
            name='circles',
            field=models.ManyToManyField(related_name='users', through='whispersservices.CircleUser', to='whispersservices.Circle'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
